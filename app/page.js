...
import { Accordion, AccordionItem, Autocomplete, AutocompleteItem, Avatar, Button, CalendarDate, DateInput, DatePicker, Input, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, useDisclosure } from "@nextui-org/react";
...
export default function Home() {
  ...
  return (
    <main className="flex flex-col xl:flex-row dark max-w-[1600px]  bg-zinc-800 m-auto min-h-screen   ">
      <div className="min-h-screen hidden xl:flex  w-1/3  flex-col items-center justify-center">
        ...
        <div className=" flex  flex-col p-6 w-full text-white h-full ">
          {status === "authenticated" ? (
            <>
              <p>Bienvenido <b>{session.user.username}</b> </p>
              <p onClick={() => signOut()} className=" cursor-pointer hover:text-red-300  self-end underline text-zinc-300 text-sm">Cerrar sesión</p>
            </>
          ...
          <div className=" my-8 flex flex-col">
            ...
            <DatePicker className=" dark my-2" variant={"bordered"} label={"Fecha del Evento"} />
      ...
      <div className="h-20 xl:hidden flex  w-full  flex-col items-center justify-center">
        <div className=" xl:p-6 w-full h-full flex items-center justify-center " >

          <Avatar className=" h-20 w-1/2 xl:w-full  object-cover object-center " src={logo.src} />
        </div>
        {/* <div className=" flex  flex-col p-6 w-full text-white h-full ">
          {status === "authenticated" ? (
            <>
      ...
      <div className=" bg-zinc-600 xl:w-full w-screen text-white min-h-screen ">
        ...
        <div className=" flex   flex-col">
          ...
          <div className=" flex flex-wrap justify-around ">
            <p className="font-extrabold cursor-pointer bg-gray-700 text-xl text-center border h-20 xl:h-full xl:p-12 p-6 rounded-md  m-3">10.00 seg</p>
            <p className="font-extrabold cursor-pointer text-xl text-center hover:bg-gray-500 h-20 xl:h-full xl:p-12 p-6  rounded-md  m-3">20.00 seg</p>
            <p className="font-extrabold cursor-pointer  text-xl text-center hover:bg-gray-500 h-20 xl:h-full xl:p-12 p-6  rounded-md  m-3">30.00 seg</p>
            <p className="font-extrabold cursor-pointer  text-xl text-center hover:bg-gray-500 h-20 xl:h-full xl:p-12 p-6  rounded-md  m-3">40.00 seg</p>

          </div>
          <div className=" flex flex-wrap justify-around ">
            <p className="font-extrabold cursor-pointer hover:bg-gray-500 h-20 xl:h-full xl:p-12 p-6 text-xl text-center  rounded-md  m-3">50.00 seg</p>
            <p className="font-extrabold cursor-pointer text-xl text-center hover:bg-gray-500 h-20 xl:h-full xl:p-12 p-6  rounded-md  m-3">60.00 seg</p>
            <p className="font-extrabold cursor-pointer  text-xl text-center hover:bg-gray-500 h-20 xl:h-full xl:p-12 p-6  rounded-md  m-3">70.00 seg</p>
